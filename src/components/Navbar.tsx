  ...
  return (
    <>
      <motion.nav
        ...
        className="fixed left-0 right-0 top-0 z-50 bg-white py-3 shadow-[0_1px_0_rgba(0,0,0,0.08)]"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            {/* Logo */}
            <Link href="/" className="group flex items-center gap-3">
              <div className="relative h-10 w-10 flex-shrink-0 overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-black/5 transition-transform duration-300 group-hover:scale-105">
                <Image src="/images/logo.jpg" alt="LTB Logo" fill className="object-contain" />
              </div>
              <div className="hidden sm:block">
                <span className="block font-heading text-base font-bold leading-tight text-gray-900">
                  Lomé Turque Brique
                </span>
                <span className="block text-[11px] text-gray-400">Matériaux de construction</span>
              </div>
            </Link>
            ...
            <div className="hidden items-center gap-1 md:flex">
                  ...
                  >
                    ...
                    {active && (
                      <motion.span
                        ...
                        className="absolute bottom-1.5 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full bg-primary-dark"
                      />
                    )}
                  </Link>
                );
              ...
              <div className="ml-2">
                <Link
                  href="/contact/"
                  className="group inline-flex items-center gap-2 rounded-full bg-primary-dark px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-primary-dark/25 transition-all duration-300 hover:bg-primary-navy"
                >
                  Devis gratuit
                  <ChevronRight
                    size={14}
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-xl text-gray-700 transition-all duration-200 hover:bg-gray-100 md:hidden"
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <ChevronRight
                          size={16}
                          className={active ? "text-primary-dark" : "text-gray-300"}
                        />
                      </Link>
                    </motion.div>
                  );
